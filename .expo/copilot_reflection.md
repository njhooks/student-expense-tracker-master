...
How to properly access and run the project:

While setting up the project, there was some confusion because the app files were inside an inner project folder. To correctly access and run the application, I followed these steps:

Navigate into the project directory:

cd student-expense-tracker-master
Confirm the project structure if needed:
dir
